...
ActiveRecord::Schema[7.1].define(version: 2023_11_03_034439) do
  ...
  create_table "guesthouses", force: :cascade do |t|
    ...
    t.text "use_policy"
    t.datetime "checkin_hour", default: "2023-11-06 17:00:00"
    t.datetime "checkout_hour", default: "2023-11-06 15:00:00"
