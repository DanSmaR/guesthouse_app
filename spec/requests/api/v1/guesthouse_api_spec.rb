...
describe 'Guesthouse API', type: :request do
  context 'GET /api/v1/guesthouses' do
    it 'returns a list of active guesthouses' do
      ...
      expect(parsed_body[0][:checkin_hour]).to eq(guesthouse[0].checkin_hour.strftime("%H:%M"))
      expect(parsed_body[0][:checkout_hour]).to eq(guesthouse[0].checkout_hour.strftime("%H:%M"))
      ...
      expect(parsed_body[1][:checkin_hour]).to eq(guesthouse[1].checkin_hour.strftime("%H:%M"))
      expect(parsed_body[1][:checkout_hour]).to eq(guesthouse[1].checkout_hour.strftime("%H:%M"))
  ...
  context 'GET /api/v1/guesthouses/1' do
    it 'returns a guesthouse' do
      ...
      expect(parsed_body[:checkin_hour]).to eq(guesthouse[0].checkin_hour.strftime("%H:%M"))
      expect(parsed_body[:checkout_hour]).to eq(guesthouse[0].checkout_hour.strftime("%H:%M"))
